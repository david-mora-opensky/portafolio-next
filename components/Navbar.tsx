import { logo, profileImgHeader } from "@/public/assets";
    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/assets/cv_david_mora.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              <MdOutlineClose
                ...
                className="text-3xl text-textGreen cursor-pointer hover:text-red-500 top-4 right-4"
              />
              <div className="flex flex-col mt-5 items-center gap-7">
                ...
                <a className="flex gap-4 my-2" href="/assets/cv_david_mora.pdf" target="_blank">
                  <motion.button
                    initial={{ x: 20, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                ...
                <div className="flex gap-4 my-2">
                  <motion.a
                    ...
                    href="https://github.com/davidmora02"
                    target="_blank"
                  >
